...
describe("sortEvenOdd", () => {
  ...
  it("case 3", () => {
    expect(sortEvenOdd([4, 1, 2, 3, 11, 14, 15, 61, 78, 72, 75, 2, 57, 25, 27, 2])).toEqual([
      2, 72, 4, 61, 11, 25, 15, 14, 27, 3, 57, 2, 75, 2, 78, 1,
    ]);
  });

  it("case 4", () => {
    expect(sortEvenOdd([5, 39, 33, 5, 12, 27, 20, 45, 14, 25, 32, 33, 30, 30, 9, 14, 44, 15, 21])).toEqual([
